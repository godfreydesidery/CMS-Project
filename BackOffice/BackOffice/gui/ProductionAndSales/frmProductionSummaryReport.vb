...
Public Class frmProductionSummaryReport
    ...
    Private Sub createDocument(doc As Document)
        ...
        documentTitle.AddText("Summarized Production Report")
        ...
        For i As Integer = 0 To dtgrdList.RowCount - 1
            ...
            Dim costPrice As String = dtgrdList.Item(3, i).Value.ToString
            Dim sellingPrice As String = dtgrdList.Item(4, i).Value.ToString
    ...
    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnExportToPDF.Click
        ...
        document.Info.Title = "Summarized Production Report"
        document.Info.Subject = "Summarized Production Report"
        ...
        Dim filename As String = LSystem.getRoot & "\Summarized Production Report " & dateStart.Text & dateEnd.Text & cmbCategory.Text & ".pdf"
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles btnExportToExcel.Click
        ...
        shXL.Cells(r, 1).Value = "Summarized Production Report"
        ...
        shXL.Cells(r, 4).Value = "C Price"
        shXL.Cells(r, 5).Value = "S Price"
        ...
        Dim strFileName As String = LSystem.saveToDesktop & "\Summarized Production Report " & dateStart.Text & dateEnd.Text & ".xls"
