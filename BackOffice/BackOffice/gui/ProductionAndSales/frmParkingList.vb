...
Public Class frmPackingList
    ...
    Private Sub createDocument(doc As Document)
        ...
        paragraph = section.AddParagraph()
        If report = True Then
            paragraph.AddFormattedText("Packing List and Returns (Preliminary Report)", TextFormat.Bold)
        Else
            paragraph.AddFormattedText("Packing List and Returns", TextFormat.Bold)
        End If
        paragraph.Format.Alignment = ParagraphAlignment.Center
        paragraph.Format.Font.Size = 9
        paragraph.Format.Font.Color = Colors.Green
